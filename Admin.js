...
<title>MONDECO — Connexion administration</title>
...
body{
  ...
  color:var(--ink);
  background:
    radial-gradient(circle at 95% 5%,rgba(237,28,36,.08),transparent 28%),
    radial-gradient(circle at 5% 95%,rgba(174,145,125,.09),transparent 32%),
    var(--ivory);
}
...
.login-shell{
  ...
  overflow:hidden;
  border:1px solid rgba(215,201,190,.86);
  border-radius:28px;
  background:rgba(255,253,249,.92);
  box-shadow:0 32px 90px rgba(50,35,27,.14);
}
...
.brand-side{
  ...
  background:
    radial-gradient(circle at 10% 10%,rgba(237,28,36,.14),transparent 30%),
    linear-gradient(160deg,#1a1714,#0f0e0d);
}
...
.logo-plaque{
  ...
  background:
    radial-gradient(circle at 100% 0%,rgba(237,28,36,.08),transparent 35%),
    linear-gradient(145deg,#fffefa,#f1ebe4);
...
.eyebrow:before{
  ...
  border-radius:50%;
  background:#3eb576;
  box-shadow:0 0 0 5px rgba(62,181,118,.12);
}
...
.login-side{
  display:flex;
  align-items:center;
  padding:50px clamp(34px,5vw,66px);
  background:
    radial-gradient(circle at 100% 0%,rgba(237,28,36,.045),transparent 34%),
    var(--card);
}
...
.toggle-pass:hover{background:#f6f0eb;color:var(--ink)}
...
.submit-btn{
  ...
  font-weight:850;
  cursor:pointer;
  box-shadow:0 14px 30px rgba(237,28,36,.22);
  transition:.18s ease;
}

.submit-btn:hover{
  transform:translateY(-1px);
  box-shadow:0 17px 36px rgba(237,28,36,.28);
}
...
.tip-icon{
  ...
  background:#fff;
  color:var(--red);
  box-shadow:0 4px 12px rgba(40,28,21,.06);
  font-weight:900;
}
...
@media(max-width:820px){
  ...
  .brand-side{padding:28px;gap:38px}
  .brand-copy h1{font-size:32px}
  .brand-copy p{font-size:14px}
  .login-side{padding:34px 26px 38px}
  .logo-plaque{width:270px}
}

@media(max-width:480px){
  .brand-side{padding:22px}
  .login-side{padding:30px 20px 34px}
  .login-box h2{font-size:31px}
}
</style>
</head>
...
<div class="login-shell">
  ...
  <section class="login-side">
    <div class="login-box">
      ...
      <div class="mini-label">Administration MONDECO</div>

      <h2>Connexion</h2>

      <div class="sub">
        Saisissez votre mot de passe administrateur pour accéder au tableau de bord.
      </div>
      ...
      <form id="form">
        ...
        <button class="submit-btn" id="btn" type="submit">
          Se connecter
        </button>
      ...
      <div class="security-tip">
        ...
        <div>
          <strong>Astuce sécurité</strong><br>
          Utilisez le mot de passe défini dans la variable
          <b>ADMIN_PASSWORD</b> de Railway et ne le stockez jamais dans GitHub.
        </div>
      </div>

      <div class="footer-note">
        MONDECO • Agent WhatsApp • Accès réservé
      </div>
    </div>
  </section>
</div>
