// ============================================================
// MONDECO - AGENT WHATSAPP + INSTAGRAM + FACEBOOK + COMMENTAIRES + IA + RESPONSABLE COMMERCIAL + SLA — V6.33.0
// server.js
//
// Ajouts V5 :
...
// V6.33.0 — Facebook : sépare Messenger et Pages/Commentaires.
...
console.log('🚀 MONDECO OMNICANAL WHATSAPP + INSTAGRAM + FACEBOOK V6.33.0');
console.log(
  '=============================================='
);
  ...
  async ({
    ...
    updateConversationState(
      ...
      current => ({
        ...
        // V6.33.0 — une réponse commerciale acquitte tous les messages
